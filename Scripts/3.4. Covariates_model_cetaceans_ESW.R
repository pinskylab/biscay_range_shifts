...
density_esw = fit_model( "settings"=settings, 
                         ...
                         "b_i"=del$Density,
                         "a_i"=rep(1,nrow(del)),
                         "X_gtp"=array(X_gtp[,,c(1,3)],dim=c(nrow(X_gtp),ncol(X_gtp),2)), #quadratic
                         "X_itp"=array(X_itp[,,c(1,3)],dim=c(nrow(X_itp),ncol(X_itp),2)), 
...
density_esw = fit_model( "settings"=settings, 
                         ...
                         "b_i"=del$Density,
                         "a_i"=rep(1,nrow(del)),
                         "X_gtp"=array(X_gtp[,,c(2,4)],dim=c(nrow(X_gtp),ncol(X_gtp),2)),#quadratic
...
setwd("C:/use/PREDOC/Scripts/0ChapterIII/VAST/Output/New")
fit1<-readRDS("density_lognormal_grid_4444_nao.RDS") 
summary(fit1)
